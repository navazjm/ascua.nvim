...
theme.set_highlights = function(opts)
    ...
    hl(0, "spellbad", { fg = c.black, bg = c.red, sp = c.error_red })
    hl(0, "spellcap", { fg = c.black, bg = c.yellow, sp = c.warning_yellow })
    hl(0, "spellrare", { fg = c.black, bg = c.magenta,sp = c.blue })
    hl(0, "spelllocal", { fg = c.black, bg = c.cyan, sp = c.blue })
